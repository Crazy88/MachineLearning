...
```
The decision tree is 50% accurate when applied to the testing data.  Not very good. Instead of spending time tuning the model, I examine other approaches:  
...
```
Random forests is 100% accurate when applied to the testing data.  
...
conMatrixBoost
```
Boosting is over 97% accurate when applied to the testing data.    
...
conMatrixRFtest
```
As expected, accuracy decreases slightly when going from training to testing data sets. The out of sample error rate (1-accuracy) is still under 1%.   
